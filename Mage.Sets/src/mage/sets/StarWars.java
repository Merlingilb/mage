...
public final class StarWars extends ExpansionSet {
    ...
    private StarWars() {
        ...
        cards.add(new SetCardInfo("Ahsoka Tano, Rogue Jedi", "815a", Rarity.MYTHIC, mage.cards.a.AhsokaTanoRogueJedi.class, new CardGraphicInfo(FrameStyle.M15_NORMAL, true)));
        cards.add(new SetCardInfo("Ahsoka Tano, Rogue Jedi", "815b", Rarity.MYTHIC, mage.cards.a.AhsokaTanoRogueJedi.class, new CardGraphicInfo(FrameStyle.M15_NORMAL, true)));
        ...
        cards.add(new SetCardInfo("CT-7567, Captain Rex", 816, Rarity.RARE, mage.cards.c.CT7567CaptainRex.class));
        ...
        cards.add(new SetCardInfo("Demolitions Trooper", 811, Rarity.UNCOMMON, mage.cards.d.DemolitionsTrooper.class));
        ...
        cards.add(new SetCardInfo("Evade the Empire", 805, Rarity.COMMON, mage.cards.e.EvadeTheEmpire.class));
        ...
        cards.add(new SetCardInfo("Fulcrum Intelligence", 806, Rarity.UNCOMMON, mage.cards.f.FulcrumIntelligence.class));
        ...
        cards.add(new SetCardInfo("Garazeb Orrelios", 818, Rarity.MYTHIC, mage.cards.g.GarazebOrrelios.class));
        ...
        cards.add(new SetCardInfo("Grand Admiral Thrawn", "819a", Rarity.RARE, mage.cards.g.GrandAdmiralThrawn.class, new CardGraphicInfo(FrameStyle.M15_NORMAL, true)));
        cards.add(new SetCardInfo("Grand Admiral Thrawn", "819b", Rarity.RARE, mage.cards.g.GrandAdmiralThrawn.class, new CardGraphicInfo(FrameStyle.M15_NORMAL, true)));
        ...
        cards.add(new SetCardInfo("Heart of the Rebellion", 820, Rarity.UNCOMMON, mage.cards.h.HeartOfTheRebellion.class));
        cards.add(new SetCardInfo("Heavy Trooper", 78, Rarity.COMMON, mage.cards.h.HeavyTrooper.class));
        cards.add(new SetCardInfo("Hera Syndulla", 812, Rarity.RARE, mage.cards.h.HeraSyndulla.class));
        ...
        cards.add(new SetCardInfo("Imperial Hotshot", 807, Rarity.COMMON, mage.cards.i.ImperialHotshot.class));
        cards.add(new SetCardInfo("Imperial Hovertank", 307, Rarity.UNCOMMON, mage.cards.i.ImperialHovertank.class));
        cards.add(new SetCardInfo("Imperial Inquisition", 808, Rarity.RARE, mage.cards.i.ImperialInquisition.class));
        cards.add(new SetCardInfo("Imperial Power Play", 8, Rarity.UNCOMMON, mage.cards.i.ImperialPowerPlay.class));
        cards.add(new SetCardInfo("Imperial Security Officer", 809, Rarity.UNCOMMON, mage.cards.i.ImperialSecurityOfficer.class));
        ...
        cards.add(new SetCardInfo("Island", "520e", Rarity.LAND, mage.cards.basiclands.Island.class, new CardGraphicInfo(FrameStyle.ZEN_FULL_ART_BASIC, true)));
        ...
        cards.add(new SetCardInfo("Island", "830f", Rarity.LAND, mage.cards.basiclands.Island.class, new CardGraphicInfo(FrameStyle.ZEN_FULL_ART_BASIC, true)));
        ...
        cards.add(new SetCardInfo("Kallus, Imperial Traitor", 822, Rarity.RARE, mage.cards.k.KallusImperialTraitor.class));
        cards.add(new SetCardInfo("Kamino Cloning Facility", 246, Rarity.RARE, mage.cards.k.KaminoCloningFacility.class));
        cards.add(new SetCardInfo("Kanan Jarrus, Hidden Jedi", 823, Rarity.RARE, mage.cards.k.KananJarrusHiddenJedi.class));
        ...
        cards.add(new SetCardInfo("Loth-Wolf Pack", 824, Rarity.UNCOMMON, mage.cards.l.LothWolfPack.class));
        ...
        cards.add(new SetCardInfo("Plains", "520e", Rarity.LAND, mage.cards.basiclands.Plains.class, new CardGraphicInfo(FrameStyle.ZEN_FULL_ART_BASIC, true)));
        ...
        cards.add(new SetCardInfo("Quiet Ending", 802, Rarity.COMMON, mage.cards.q.QuietEnding.class));
        ...
        cards.add(new SetCardInfo("Rebel Astromechs", 827, Rarity.COMMON, mage.cards.r.RebelAstromechs.class));
        cards.add(new SetCardInfo("Recover", 810, Rarity.COMMON, mage.cards.r.Recover.class));
        ...
        cards.add(new SetCardInfo("Sabine Wren", 825, Rarity.RARE, mage.cards.s.SabineWren.class));
        ...
        cards.add(new SetCardInfo("Savage Smash", 826, Rarity.UNCOMMON, mage.cards.s.SavageSmash.class));
        cards.add(new SetCardInfo("Saved by the Rebellion", 814, Rarity.UNCOMMON, mage.cards.s.SavedByTheRebellion.class));
        ...
        cards.add(new SetCardInfo("Spark of Rebellion", 803, Rarity.UNCOMMON, mage.cards.s.SparkOfRebellion.class));
        ...
        cards.add(new SetCardInfo("The Darksaber", 828, Rarity.MYTHIC, mage.cards.t.TheDarksaber.class));
        cards.add(new SetCardInfo("The Death Star", 1, Rarity.MYTHIC, mage.cards.t.TheDeathStar.class));
        cards.add(new SetCardInfo("The Ghost", 829, Rarity.RARE, mage.cards.t.TheGhost.class));
        ...
        cards.add(new SetCardInfo("Trooper Medic", 804, Rarity.UNCOMMON, mage.cards.t.TrooperMedic.class));
