...
public enum CounterType {
    ...
    PREY("prey"),
    PUPA("pupa"),
    PURE_BLACK_MANA("black mana not to be used for generic mana"),
    PURE_BLUE_MANA("blue mana not to be used for generic mana"),
    PURE_GREEN_MANA("green mana not to be used for generic mana"),
    PURE_RED_MANA("red mana not to be used for generic mana"),
    PURE_WHITE_MANA("white mana not to be used for generic mana"),
    REACH("reach"),
    REPAIR("repair"),
    RITUAL("ritual"),
    ROPE("rope"),
